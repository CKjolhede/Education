...
RSpec.describe 'students index page', type: :feature do
  it 'shows all students w/ attributes' do
    ...
    student_1 = Student.create!(name: "Abraham Adams", gpa: 1.2, school_id: school_1.id)
    student_2 = Student.create!(name: "Bethany Bingham", gpa: 2.3, school_id: school_2.id)
    student_3 = Student.create!(name: "Cher CornCob", gpa: 3.4, school_id: school_3.id)
